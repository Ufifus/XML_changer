			...
			<body>
				...
				<table class="outer" width="100%">
					...
					<tr class="outer">
						...
						<td class="outer">
							<strong>Номер истории болезни, амбулаторной карты: </strong>
...
<!-- 								<xsl:when test="address:Type[@code='2']">
				...
				<table class="outer" width="100%">
					...
					<xsl:for-each select="/n1:ClinicalDocument/n1:documentationOf/n1:serviceEvent/n1:performer[@typeCode='PPRF']">
					<tr class="outer">
						<th class="outer" width="20%">
							<xsl:text>Исследование провёл</xsl:text>
						</th>
						<td class="outer">
