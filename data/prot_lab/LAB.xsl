		...
		<html>
			...
			<body>
				<table class="outer" width="100%">
					...
					<tr class="outer">
						...
						<td class="outer">
							...
							<xsl:choose>
								<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:telecom and not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:telecom[@nullFlavor])">
									<br/>
				...
				<table class="outer" width="100%">
						...
						<tr class="outer">
							...
							<td class="outer" width="20%">
								...
								<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/identity:IdentityDoc/identity:Series[@nullFlavor])">
									<xsl:text>Серия документа: </xsl:text>
								...
								<br/>
								<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/identity:IdentityDoc/identity:IssueOrgName[@nullFlavor])">
									<xsl:text>Кем выдан документ: </xsl:text>
									<xsl:value-of select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/identity:IdentityDoc/identity:IssueOrgName"/>
									<br/>
								</xsl:if>
								<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/identity:IdentityDoc/identity:IssueOrgCode[@nullFlavor])">
					...
					<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode[@nullFlavor])">
					<tr class="outer">
						<th class="outer" width="20%">
					...
					<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:birthTime[@nullFlavor])">
					<tr class="outer">
						<th class="outer" width="20%">
					...
					<tr class="outer">
						...
						<td class="outer">
						<xsl:if test="not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr[@nullFlavor])">
							...
							<xsl:choose>
								...
								<xsl:when test="address:Type[@code='4']">
									<strong>Адрес места учебы/работы: </strong>
									<br/>
									<xsl:apply-templates select="."/>
								</xsl:when>
							</xsl:choose>
						...
						<xsl:if test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr[@nullFlavor]">
							<strong>Адрес: </strong>
							<br/>
							<xsl:text>Не указан</xsl:text>
						</xsl:if>
							<xsl:choose>
								<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom and not(/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom[@nullFlavor])">
									<br/>
				...
				<br/>
				<xsl:if test="/n1:ClinicalDocument/n1:participant[@typeCode='REF']">
				<table class="outer" width="100%">
					<col width="40%"/>
					<col width="60%"/>							
					<tr class="outer">
						...
						<td class="outer">
							...
							<br/>
								...
								<xsl:call-template name="translateCode">
									<xsl:with-param name="code" select="/n1:ClinicalDocument/n1:participant[@typeCode='REF']/n1:associatedEntity/n1:code"/>
								</xsl:call-template>
							<br/>
							<br/>
							<strong>Медицинская организация: </strong>
								<xsl:value-of select="/n1:ClinicalDocument/n1:participant[@typeCode='REF']/n1:associatedEntity/n1:scopingOrganization/n1:name"/>
							<xsl:choose>
								<xsl:when test="not(/n1:ClinicalDocument/n1:participant[@typeCode='REF']/n1:associatedEntity/n1:scopingOrganization/n1:addr[@nullFlavor])">
									<br/>
									<xsl:text>Адрес:</xsl:text>
									<xsl:apply-templates select="/n1:ClinicalDocument/n1:participant[@typeCode='REF']/n1:associatedEntity/n1:scopingOrganization/n1:addr"/>
								</xsl:when>
							</xsl:choose>
							<br/>
						</td>
				...
				<br/>
				<xsl:if test="not(/n1:ClinicalDocument/n1:documentationOf/n1:serviceEvent/n1:performer[@nullFlavor])">
				<table class="outer" width="100%">
					<col width="40%"/>
					<col width="60%"/>							
					<tr class="outer">
				...
				<table class="outer" width="100%">
					...
					<tr class="outer">
						<th class="outer" width="20%">
							<xsl:text>Случай оказания медицинской помощи:</xsl:text>
						</th>
						<td class="outer">
							<strong>Дата начала:  </strong>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:low/@value,7,2)"/>
							<xsl:text>.</xsl:text>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:low/@value,5,2)"/>
							<xsl:text>.</xsl:text>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:low/@value,1,4)"/>
							<xsl:if test="/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:high">
							<br/>
							<strong>Дата окончания:  </strong>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:high/@value,7,2)"/>
							<xsl:text>.</xsl:text>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:high/@value,5,2)"/>
							<xsl:text>.</xsl:text>
							<xsl:value-of select="substring(/n1:ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:effectiveTime/n1:high/@value,1,4)"/>
							</xsl:if>	
							<br/>
						</td>
					</tr>
