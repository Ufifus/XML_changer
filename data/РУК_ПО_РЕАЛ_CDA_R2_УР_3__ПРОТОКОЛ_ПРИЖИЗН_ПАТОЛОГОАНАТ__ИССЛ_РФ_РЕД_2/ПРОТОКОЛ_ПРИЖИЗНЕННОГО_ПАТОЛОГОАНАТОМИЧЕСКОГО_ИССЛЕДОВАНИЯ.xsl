<?xml version="1.0"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fias="urn:hl7-ru:fias" xmlns:identity="urn:hl7-ru:identity" xmlns:medService="urn:hl7-ru:medService" xmlns:address="urn:hl7-ru:address">
				...
				<table class="outer" width="100%">
					...
					<tr class="outer">
						...
						<td class="outer">
							...
							<br/>
							<xsl:choose>
								<xsl:when test="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr[@nullFlavor]">
									<xsl:text>Не указан</xsl:text>
								</xsl:when>
								<xsl:otherwise>
									<xsl:apply-templates select="/n1:ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr[address:Type/@code='1']"/>
								</xsl:otherwise>
							</xsl:choose>
							<br/>
							<strong>Контакты:</strong>
							...
							<td class="outer">
								...
								<xsl:choose>
									<xsl:when test="/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:telecom">
										<xsl:if test="not(/n1:ClinicalDocument/n1:author/n1:assignedAuthor/n1:telecom[@nullFlavor])">
						...
						<td class="outer">
							...
							<xsl:choose>
								<xsl:when test="/n1:ClinicalDocument/n1:legalAuthenticator/n1:assignedEntity/n1:telecom">
									<xsl:if test="not(/n1:ClinicalDocument/n1:legalAuthenticator/n1:assignedEntity/n1:telecom[@nullFlavor])">
