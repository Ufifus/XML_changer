...
def main():
    ...
    clear_plot()
    # xml_list= ["Эпикриз законченный короткий", "Эпикриз законченный полный", "Эпикриз выписной в стационаре min","Эпикриз выписной в стационаре max", "Приложение_Д", "Приложение_Е"]
    xml_list = ["Эпикриз выписной в стационаре min", "Эпикриз выписной в стационаре max"]
    doc_type = st.sidebar.selectbox(
        "Выбор документа",( xml_list ),
        index=1,
    )
